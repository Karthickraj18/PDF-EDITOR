    ...
    return (
        ...
        >
            <div className="text-center mb-12">
                <h1 className="text-4xl md:text-5xl font-heading font-bold text-white mb-4 tracking-tight">Merge PDFs</h1>
                <p className="text-xl text-text-muted font-body max-w-2xl mx-auto">
                    Combine multiple PDFs into a single document. Fast, secure, and entirely in your browser.
                </p>
            </div>
            ...
            <FileUploadZone
                ...
                allowMultiple={true}
                message="Drag & drop multiple PDFs to merge"
            />
            ...
            <AnimatePresence mode="wait">
                ...
                {isProcessing && (
                    ...
                    >
                        ...
                        <h3 className="text-white font-heading font-medium mb-4">Merging your files...</h3>
                ...
                {downloadUrl && (
                    ...
                    >
                        <div className="glass-card p-8 rounded-2xl flex flex-col items-center border-green-500/30 bg-green-500/5 mb-6">
                            ...
                            <p className="text-text-muted mb-6">Your PDFs have been magically merged.</p>
